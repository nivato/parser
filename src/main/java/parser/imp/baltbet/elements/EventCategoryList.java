...
public class EventCategoryList extends WebComponent<EventCategoryList>{

	public EventCategoryList(WebDriver driver, By findByMethod) {
		super(driver, findByMethod);
	}
	
	public Map<String, Link> getCategoryLinks(){
